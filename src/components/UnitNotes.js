...
const UnitNotes = () => {
  ...
  const unitNotesData = {
    ...
    "Data Warehousing": [
      {
        ...
        syllabus: "/resources/pdf/DW_Syllabus.pdf",
        resource: "",
    ...
    "Network Security": [
      {
        ...
        resource: "",
        description: "Understand fundamental network security principles, threats, and defense mechanisms.",
        questionsResource: ""
      },
      {
        unit: "Unit 2: KEY MANAGEMENT AND AUTHENTICATION",
        syllabus: "/resources/pdf/NS_Syllabus.pdf",
        resource: "",
        description: " Learn secure methods for key distribution and verifying user identities.",
        questionsResource: ""
      },
      {
      ...
      },
      {
        ...
        syllabus: "/resources/pdf/NS_Syllabus.pdf",
        resource: "",
        description: "Secure applications against vulnerabilities using encryption and secure protocols.",
        questionsResource: ""
      },
      {
        unit: "Unit 5: SECURITY PRACTICES",
        syllabus: "/resources/pdf/NS_Syllabus.pdf",
        resource: "",
        description: "Apply best practices, risk assessment, and mitigation techniques to enhance network security.",
        questionsResource: ""
      }
    ],
    "Multimedia And Animation": [
      {
        ...
        syllabus: "/resources/pdf/M&A_Syllabus.pdf",
        resource: "",
        description: "Understand the basics of multimedia, including text, images, audio, video, and animation.",
        questionsResource: ""
      },
      {
        unit: "Unit 2: MULTIMEDIA FILE FORMATS AND STANDARDS",
        syllabus: "/resources/pdf/M&A_Syllabus.pdf",
        resource: "",
        description: "Learn different file formats (JPEG, MP3, MP4) and industry standards for multimedia content.",
        questionsResource: ""
      },
      {
        unit: "Unit 3: MULTIMEDIA AUTHORING",
        syllabus: "/resources/pdf/M&A_Syllabus.pdf",
        resource: "",
        description: "Gain knowledge of tools and techniques for creating interactive multimedia applications.",
        questionsResource: ""
      },
      {
        unit: "Unit 4: ANIMATION",
        syllabus: "/resources/pdf/M&A_Syllabus.pdf",
        resource: "",
        description: " Explore the principles, techniques, and software used in 2D and 3D animation.",
        questionsResource: ""
      },
      {
        unit: "Unit 5: MULTIMEDIA APPLICATIONS",
        syllabus: "/resources/pdf/M&A_Syllabus.pdf",
        resource: "",
        description: "Discover various real-world applications of multimedia in education, entertainment, and business.",
        questionsResource: ""
      },
    ],
    "Introduction To Industrial Engineering": [
      {
        unit: "Unit 1: Introduction",
        syllabus: "/resources/pdf/IIE_Syllabus.pdf",
        resource: "",
        description: "Understanding the fundamentals and scope of industrial engineering in optimizing production and operations.",
        questionsResource: ""
      },
      {
        unit: "Unit 2:  PLANT LOCATION AND LAYOUT",
        syllabus: "/resources/pdf/IIE_Syllabus.pdf",
        resource: "",
        description: " Learning how to select an optimal factory location and design an efficient facility layout for productivity.",
        questionsResource: ""
      },
      {
        unit: "Unit 3: WORK SYSTEM DESIGN& ERGONOMICS",
        syllabus: "/resources/pdf/IIE_Syllabus.pdf",
        resource: "",
        description: "Studying methods to enhance work efficiency, reduce fatigue, and improve workplace ergonomics.",
        questionsResource: ""
      },
      {
        unit: "Unit 4:  STATISTICAL QUALITY CONTROL",
        syllabus: "/resources/pdf/IIE_Syllabus.pdf",
        resource: "",
        description: "Applying statistical tools to monitor and improve product quality and process stability.",
        questionsResource: ""
      },
      {
        unit: "Unit 5:  PRODUCTION PLANNING AND CONTROL",
        syllabus: "/resources/pdf/IIE_Syllabus.pdf",
        resource: "",
        description: "Managing resources, scheduling production, and ensuring smooth workflow to meet demand efficiently.",
        questionsResource: ""
      },
    ],
